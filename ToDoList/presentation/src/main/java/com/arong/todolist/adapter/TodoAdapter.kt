...
class TodoAdapter(val context: Context) : RecyclerView.Adapter<TodoAdapter.TodoViewHolder>() {
    ...
    inner class TodoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private var content = itemView.findViewById<TextView>(R.id.tv_todo)
        private var timestamp = itemView.findViewById<TextView>(R.id.tv_date)
        private var checkbox = itemView.findViewById<CheckBox>(R.id.cb_todo)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodoViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.view_todo_list_item, parent, false)
