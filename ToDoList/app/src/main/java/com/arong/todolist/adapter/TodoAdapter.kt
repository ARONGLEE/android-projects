...
class TodoAdapter(val context: Context) : RecyclerView.Adapter<TodoAdapter.TodoViewHolder>() {
    ...
    inner class TodoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var content = itemView.findViewById<TextView>(R.id.tv_todo)
        var timestamp = itemView.findViewById<TextView>(R.id.tv_date)
        var checkbox = itemView.findViewById<CheckBox>(R.id.cb_todo)
